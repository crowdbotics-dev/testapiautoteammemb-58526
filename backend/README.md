...
## Project Structure
    ...
    ├── testapiautoteammemb_58526  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_58526`
...
2. Clone this repo and `cd testapiautoteammemb_58526`
